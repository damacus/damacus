...
|:-----------|:------------|--------:|
| [**jamiedavenport/capd**](https://github.com/jamiedavenport/capd) | Open-source native macOS capture and bookmarking app. A Pinboard successor with a menu-bar app and CLI. | *4 days ago* |
