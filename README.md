...
- [allenporter/flux-local @ 7.5.4](https://github.com/allenporter/flux-local/releases/tag/7.5.4) (4 days ago)
...
- **[maxim/tiny_mcp](https://github.com/maxim/tiny_mcp)** - Make local MCP tools in Ruby and easily serve them (2 days ago)
