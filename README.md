...
|:--------|:-------:|-----:|
| [tas50/cinc-cli](https://github.com/tas50/cinc-cli/releases/tag/v0.22.0) | `v0.22.0` | *3 days ago* |
| [damacus/paperless-cli](https://github.com/damacus/paperless-cli/releases/tag/v2.1.4) | `v2.1.4` | *3 days ago* |
| [damacus/med-tracker](https://github.com/damacus/med-tracker/releases/tag/v0.5.23) | `v0.5.23` | *4 days ago* |
| [test-kitchen/kitchen-docker](https://github.com/test-kitchen/kitchen-docker/releases/tag/v3.4.1) | `v3.4.1` | *4 days ago* |
| [test-kitchen/kitchen-vagrant](https://github.com/test-kitchen/kitchen-vagrant/releases/tag/v2.4.1) | `v2.4.1` | *4 days ago* |
...
|:-----------|:------------|--------:|
| [**eleboucher/memini**](https://github.com/eleboucher/memini) | Give any MCP-capable agent persistent memory: remember/recall over a tiered store with hybrid vector &#43; keyword retrieval. Single Go binary, SQLite or Postgres, embedded admin UI. | *6 days ago* |
