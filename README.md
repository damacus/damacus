...
- [sous-chefs/java @ 13.2.0](https://github.com/sous-chefs/java/releases/tag/13.2.0) (1 day ago)
- [mealie-recipes/mealie @ v3.0.1](https://github.com/mealie-recipes/mealie/releases/tag/v3.0.1) (2 days ago)
- [test-kitchen/test-kitchen @ v3.8.0](https://github.com/test-kitchen/test-kitchen/releases/tag/v3.8.0) (3 days ago)
...
- **[crmne/ruby_llm](https://github.com/crmne/ruby_llm)** - Stop juggling AI SDKs! RubyLLM offers one delightful Ruby interface for OpenAI, Anthropic, Gemini, Bedrock, OpenRouter, DeepSeek, Ollama &amp; compatible APIs. Chat, Vision, Audio, PDF, Images, Embeddings, Tools, Streaming &amp; Rails integration. (4 days ago)
