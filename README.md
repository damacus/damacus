...
- [damacus/med-tracker @ v0.3.32](https://github.com/damacus/med-tracker/releases/tag/v0.3.32) (1 day ago)
- [damacus/unifi-release-announcer @ unifi-release-announcer-v0.2.4](https://github.com/damacus/unifi-release-announcer/releases/tag/unifi-release-announcer-v0.2.4) (1 day ago)
...
- **[setdef/RatatuiRuby](https://github.com/setdef/RatatuiRuby)** - 💎 Unofficial Ruby wrapper for Ratatui 👨‍🍳🐀. (1 day ago)
- **[amogower/freeagent-cli](https://github.com/amogower/freeagent-cli)** (3 days ago)
- **[julianfbeck/paperless-cli](https://github.com/julianfbeck/paperless-cli)** - 📄 AI Agent-ready CLI for Paperless-ngx document management 🧠✨ (3 days ago)
